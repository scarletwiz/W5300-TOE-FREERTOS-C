...
C_SRCS += \
../Drivers/mbedtls/programs/hash/generic_sum.c \
../Drivers/mbedtls/programs/hash/hello.c 

OBJS += \
./Drivers/mbedtls/programs/hash/generic_sum.o \
./Drivers/mbedtls/programs/hash/hello.o 

C_DEPS += \
./Drivers/mbedtls/programs/hash/generic_sum.d \
./Drivers/mbedtls/programs/hash/hello.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/mbedtls/programs/hash/%.o Drivers/mbedtls/programs/hash/%.su: ../Drivers/mbedtls/programs/hash/%.c Drivers/mbedtls/programs/hash/subdir.mk
...
clean: clean-Drivers-2f-mbedtls-2f-programs-2f-hash

clean-Drivers-2f-mbedtls-2f-programs-2f-hash:
	-$(RM) ./Drivers/mbedtls/programs/hash/generic_sum.d ./Drivers/mbedtls/programs/hash/generic_sum.o ./Drivers/mbedtls/programs/hash/generic_sum.su ./Drivers/mbedtls/programs/hash/hello.d ./Drivers/mbedtls/programs/hash/hello.o ./Drivers/mbedtls/programs/hash/hello.su

.PHONY: clean-Drivers-2f-mbedtls-2f-programs-2f-hash
